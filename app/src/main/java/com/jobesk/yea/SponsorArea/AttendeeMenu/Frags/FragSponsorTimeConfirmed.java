...
import com.jobesk.yea.SponsorArea.AttendeeMenu.Adapters.SponsorTimeConfirmAdapter;
...
public class FragSponsorTimeConfirmed extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private Activity activity;
    private ArrayList<AAvaliableModel> arrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private String userID;
    private SponsorTimeConfirmAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new SponsorTimeConfirmAdapter(activity, arrayList);
...
//            mParams.put("email", email);
            ...
            WebReq.get(activity, "sponsor-confirmed-ts?sponsor_id=" + userID + "&attendee_id=" + SponsorAttendeeMain.attendeID, mParams, new MyTextHttpResponseHandler());
