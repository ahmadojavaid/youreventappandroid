...
import com.jobesk.yea.SponsorArea.MeetingMenu.Adapters.SponsorMeetingsRequestsAdapter;
...
public class FragSponsorMeetingRequests extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//            mParams.put("postId", email);
            ...
            WebReq.get(getActivity(), "fetch-sponsor-requests?sponsor_id=" + userID, mParams, new MyTextHttpResponseHandler());
...
//            GlobalClass.dismissLoading();
            ...
            if (mResponse != null && mResponse.length() != 0) {
                try {
                    ...
                    FragSponsorMeetingMain.FragSponsorMeetingMain = date;
