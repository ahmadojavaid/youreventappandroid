...
public class SponsorTimeNotConfirmDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsor_time_not_confirmed_detail);
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GlobalClass.hideKeyboard(SponsorTimeNotConfirmDetails.this);
        ...
        if (timeStatus.equalsIgnoreCase("Not Confirmed")) {

            line.setVisibility(View.GONE);
            attende_msg_tv.setVisibility(View.GONE);
            cancelled_tv.setVisibility(View.GONE);

            sponsor_msg_tv.setText(sponsorMsg);

        }


        if (timeStatus.equalsIgnoreCase("Cancelled")) {


            attende_msg_tv.setText(attendeMsg);
            sponsor_msg_tv.setText(sponsorMsg);
