...
import com.jobesk.yea.SponsorArea.SAgendaDetailActivity;
import com.jobesk.yea.Utils.GlobalClass;

import java.util.ArrayList;

public class SAgendaAdapter extends RecyclerView.Adapter<SAgendaAdapter.MyViewHolder> {
    ...
    public SAgendaAdapter(Activity activity, ArrayList<AgendaModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity, SAgendaDetailActivity.class);
