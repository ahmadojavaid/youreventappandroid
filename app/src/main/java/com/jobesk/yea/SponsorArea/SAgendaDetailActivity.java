...
import com.jobesk.yea.AttendeArea.Activities.WebViewActivity;
...
public class SAgendaDetailActivity extends AppCompatActivity {
        ...
        textWall_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GlobalClass.isValidUrl(text_wall) == true) {
                    Intent i = new Intent(SAgendaDetailActivity.this, WebViewActivity.class);
                    ...
                    Toast.makeText(SAgendaDetailActivity.this, getApplicationContext().getResources().getString(R.string.correct_link), Toast.LENGTH_SHORT).show();
                }
...
//
//
//                Intent i = new Intent(SAgendaDetailActivity.this, NotesActivity.class);
...
//            mParams.put("postId", email);
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(SAgendaDetailActivity.this);
            Log.d(TAG, "onStart");
...
//                                agendaAdapter.notifyDataSetChanged();
                                    ...
                                    agendaAdapter = new AgendaSponsorAdapter(SAgendaDetailActivity.this, sponsersList);
...
//                                speakserList = new ArrayList<>();
                                    ...
                                    speakersAdapter = new AgendaSpeakersAdapter(SAgendaDetailActivity.this, speakserList);
...
//                                doclist = new ArrayList<>();
                                    ...
                                    docAdapter = new AgendaSessionsSingleAdapter(SAgendaDetailActivity.this, doclist);
