...
import com.jobesk.yea.SponsorArea.MeetingMenu.Adapters.SponsorMeetingsConfirmAdapter;
...
public class FragSponsorMeetingConfirmed extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//            mParams.put("postId", email);
            ...
            WebReq.get(getActivity(), "sponsor-meeting-confirmed?sponsor_id=" + userID, mParams, new MyTextHttpResponseHandler());
