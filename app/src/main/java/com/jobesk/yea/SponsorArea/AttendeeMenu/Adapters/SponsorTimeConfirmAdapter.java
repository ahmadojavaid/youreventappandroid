...
import com.jobesk.yea.SponsorArea.AttendeeMenu.DetailActivities.SponsorTimeConfirmDetails;
import com.jobesk.yea.Utils.GlobalClass;

import java.util.ArrayList;

public class SponsorTimeConfirmAdapter extends RecyclerView.Adapter<SponsorTimeConfirmAdapter.MyViewHolder> {
...
//            userImage = view.findViewById(R.id.userImage);
    ...
    public SponsorTimeConfirmAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, SponsorTimeConfirmDetails.class);
