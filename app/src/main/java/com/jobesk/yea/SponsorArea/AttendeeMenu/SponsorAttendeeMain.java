package com.jobesk.yea.SponsorArea.AttendeeMenu;
...
import com.jobesk.yea.SponsorArea.AttendeeMenu.Frags.FragSponsorTimeAvaliable;
import com.jobesk.yea.SponsorArea.AttendeeMenu.Frags.FragSponsorTimeConfirmed;
import com.jobesk.yea.SponsorArea.AttendeeMenu.Frags.FragSponsorTimeNotConfirmed;
...
public class SponsorAttendeeMain extends AppCompatActivity {
    ...
    public static String attendeID;
    public static String SponsorAttendeeMainDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attendeID = bundle.getStringExtra("attendeID");
    ...
    public void onMessageEvent(SponsorDateEventBus event) {

        String dateEvent = event.getDate().trim();

        toolbar_title_tv.setText(dateEvent + "");
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    FragSponsorTimeAvaliable avaliable = new FragSponsorTimeAvaliable();
                    return avaliable;

                case 1:

                    FragSponsorTimeNotConfirmed NotConfirmed = new FragSponsorTimeNotConfirmed();
                    return NotConfirmed;

                case 2:

                    FragSponsorTimeConfirmed confirmed = new FragSponsorTimeConfirmed();
                    return confirmed;
...
//            mParams.put("postId", email);
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(SponsorAttendeeMain.this);
            Log.d(TAG, "onStart");
