...
import com.jobesk.yea.SponsorArea.AttendeeMenu.Adapters.SponsorTimeNotConfirmedAdapter;
...
public class FragSponsorTimeNotConfirmed extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SponsorTimeNotConfirmedAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new SponsorTimeNotConfirmedAdapter(activity, arrayList);
...
//            mParams.put("email", email);
            ...
            WebReq.get(activity, "sponsor-not-confirmed-ts?sponsor_id=" + userID + "&attendee_id=" + SponsorAttendeeMain.attendeID, mParams, new MyTextHttpResponseHandler());
