...
public class AttendeProfileActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    private ImageView back_img;
    private TextView toolbar_title_tv;
    private FeedAdapter profileAdapterFeed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attende_profile);
        ...
        profileAdapterFeed = new FeedAdapter(AttendeProfileActivity.this, FeedListData, Integer.valueOf(myProfileStaus), headerList, nature);
        layoutManager = new LinearLayoutManager(AttendeProfileActivity.this, LinearLayoutManager.VERTICAL, false);
...
//            } else {
            String url = "user/" + userIDpre + "?userId=" + userIDCurrent;
            WebReq.get(getApplicationContext(), url, mParams, new MyTextHttpResponseHandlerGETFEedAttendee());
    ...
    private class MyTextHttpResponseHandlerGETFEedAttendee extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            ...
            if (refresh == true) {
                ...
                GlobalClass.showLoading(AttendeProfileActivity.this);
            }
...
// get all posts
                                ...
                                if (jsonArrayPosts.length() > 0) {
                                    ...
                                    for (int j = 0; j < jsonArrayPosts.length(); j++) {
                                        ...
                                        Log.d("singlePostdata", jsonObject + "");
...
//                                        userImage = jsonObjectPosts.getString("profileImage");
                        ...
                        Toast.makeText(AttendeProfileActivity.this, "" + message, Toast.LENGTH_SHORT).show();
                    }
            ...
            if (mResponse != null && mResponse.length() != 0) {
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        GlobalClass.hideKeyboard(AttendeProfileActivity.this);
