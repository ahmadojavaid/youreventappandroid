package com.jobesk.yea.AttendeArea.MeetingMenu;
...
import com.jobesk.yea.AttendeArea.MeetingMenu.Frags.FragAttendeMeetingCancelled;
import com.jobesk.yea.AttendeArea.MeetingMenu.Frags.FragAttendeMeetingConfirmed;
import com.jobesk.yea.AttendeArea.MeetingMenu.Frags.FragAttendeMeetingRequests;
...
public class FragAttendeMeetingMain extends Fragment {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ...
                    FragAttendeMeetingRequests requests = new FragAttendeMeetingRequests();
                    return requests;
                case 1:

                    FragAttendeMeetingConfirmed confirmed = new FragAttendeMeetingConfirmed();
                    return confirmed;
                case 2:

                    FragAttendeMeetingCancelled cancelled = new FragAttendeMeetingCancelled();
                    return cancelled;
