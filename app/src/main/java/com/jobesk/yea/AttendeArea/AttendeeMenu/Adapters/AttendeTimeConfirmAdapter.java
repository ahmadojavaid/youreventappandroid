...
import com.jobesk.yea.AttendeArea.AttendeeMenu.DetailActivities.AttendeTimeConfirmDetails;
...
public class AttendeTimeConfirmAdapter extends RecyclerView.Adapter<AttendeTimeConfirmAdapter.MyViewHolder> {
...
//            userImage = view.findViewById(R.id.userImage);
    ...
    public AttendeTimeConfirmAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, AttendeTimeConfirmDetails.class);
