...
import com.jobesk.yea.AttendeArea.MeetingMenu.Adapters.SponsorMeetingsCancelledAdapter;
...
public class FragAttendeMeetingCancelled extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//            mParams.put("postId", email);
            ...
            WebReq.get(getActivity(), "attendee-cancelled-ts?attendee_id=" + userID, mParams, new MyTextHttpResponseHandler());
