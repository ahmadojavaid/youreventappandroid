package com.jobesk.yea.AttendeArea.MeetingMenu.Frags;
...
import com.jobesk.yea.AttendeArea.MeetingMenu.Adapters.SponsorMeetingsRequestsAdapter;
...
public class FragAttendeMeetingRequests extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private SponsorMeetingsRequestsAdapter mAdapter;
    private Activity activity;
    private ArrayList<AAvaliableModel> arrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private String TAG = "FragAttendeMeetingRequests";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_sponsor_meeting_request, container, false);
        ...
        mAdapter = new SponsorMeetingsRequestsAdapter(activity, arrayList);
...
//            mParams.put("postId", email);
            ...
            WebReq.get(getActivity(), "fetch-attendee-requests?attendee_id=" + userID, mParams, new MyTextHttpResponseHandler());
...
//            GlobalClass.dismissLoading();
            ...
            if (mResponse != null && mResponse.length() != 0) {
                try {
                    ...
                    FragAttendeMeetingMain.dateEvent = date;
                    ...
                    if (status.equals("1")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String ATTENDEE_MESSAGE = jsonObject.getString("SPONSOR_MESSAGE");
