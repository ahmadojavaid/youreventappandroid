...
public class AttendeConfirmDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sponsor_meeting_confrim_detail);
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GlobalClass.hideKeyboard(AttendeConfirmDetailActivity.this);
