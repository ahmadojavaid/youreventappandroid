...
import com.jobesk.yea.AttendeArea.MeetingMenu.Activities.AttendeConfirmDetailActivity;
...
public class SponsorMeetingsConfirmAdapter extends RecyclerView.Adapter<SponsorMeetingsConfirmAdapter.MyViewHolder> {
    ...
    public SponsorMeetingsConfirmAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, AttendeConfirmDetailActivity.class);
