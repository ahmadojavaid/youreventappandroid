package com.jobesk.yea.AttendeArea.MeetingMenu.Adapters;
...
import com.jobesk.yea.AttendeArea.MeetingMenu.Activities.AttendeRequestDetailActivity;
...
public class SponsorMeetingsRequestsAdapter extends RecyclerView.Adapter<SponsorMeetingsRequestsAdapter.MyViewHolder> {
    ...
    public SponsorMeetingsRequestsAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(activity, AttendeRequestDetailActivity.class);
