...
import com.jobesk.yea.AttendeArea.AttendeeMenu.DetailActivities.AttendeTimeAvaliableDetails;
...
public class AttendeTimeAvailableAdapter extends RecyclerView.Adapter<AttendeTimeAvailableAdapter.MyViewHolder> {
    ...
    public AttendeTimeAvailableAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, AttendeTimeAvaliableDetails.class);
