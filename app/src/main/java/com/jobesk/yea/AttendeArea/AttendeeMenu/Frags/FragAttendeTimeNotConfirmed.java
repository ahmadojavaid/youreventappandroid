...
import com.jobesk.yea.AttendeArea.AttendeeMenu.Adapters.AttendeTimeNotConfirmedAdapter;
...
public class FragAttendeTimeNotConfirmed extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private AttendeTimeNotConfirmedAdapter mAdapter;
    private Activity activity;
    private ArrayList<AAvaliableModel> arrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private String userID;
    private String TAG = "FragAttendeTimeNotConfirmed";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_sponsor_time_not_confirm_detail, container, false);
        ...
        mAdapter = new AttendeTimeNotConfirmedAdapter(activity, arrayList);
...
//            mParams.put("email", email);
            ...
            WebReq.get(activity, "attendee-not-confirmed-ts?attendee_id=" + userID+"&sponsor_id="+AttendeeMainCalender.SponsorID, mParams, new MyTextHttpResponseHandler());
...
//                            String session_id = jsonObject.getString("SESSION_ID");
                            ...
                            String sponsor_attende = jsonObject.getString("ATTENDEE_MESSAGE");
...
//                            model.setSession_id(session_id);
                            ...
                            model.setAttendee_msg(sponsor_attende);
