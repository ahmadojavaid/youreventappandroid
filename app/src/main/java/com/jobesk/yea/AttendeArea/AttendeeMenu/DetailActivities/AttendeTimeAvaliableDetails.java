...
public class AttendeTimeAvaliableDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GlobalClass.hideKeyboard(AttendeTimeAvaliableDetails.this);
                finish();
...
//                window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    private void updateData() {
        ...
        if (GlobalClass.isOnline(getApplicationContext()) == true) {
            ...
            mParams.put("attendee_id", userID);
            mParams.put("sponsor_id", AttendeeMainCalender.SponsorID);
            mParams.put("message", msg);

            WebReq.post(getApplicationContext(), "attendee-request-ts", mParams, new MyTextHttpResponseHandler());
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(AttendeTimeAvaliableDetails.this);
            Log.d(TAG, "onStart");
