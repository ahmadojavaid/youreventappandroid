package com.jobesk.yea.AttendeArea.MeetingMenu.Activities;
...
public class AttendeRequestDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title_tv.setText(FragAttendeMeetingMain.dateEvent+"");
        ...
        back_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GlobalClass.hideKeyboard(AttendeRequestDetailActivity.this);
...
//                window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    private void getData(String status) {
        ...
        if (GlobalClass.isOnline(getApplicationContext()) == true) {
            ...
            WebReq.post(getApplicationContext(), "attendee-response", mParams, new MyTextHttpResponseHandler());
    ...
    private class MyTextHttpResponseHandler extends JsonHttpResponseHandler {
        ...
        public void onStart() {
            super.onStart();
            GlobalClass.showLoading(AttendeRequestDetailActivity.this);
            Log.d(TAG, "onStart");
