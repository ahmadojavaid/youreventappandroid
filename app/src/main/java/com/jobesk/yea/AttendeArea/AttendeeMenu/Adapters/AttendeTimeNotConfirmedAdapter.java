package com.jobesk.yea.AttendeArea.AttendeeMenu.Adapters;
...
import com.jobesk.yea.AttendeArea.AttendeeMenu.DetailActivities.AttendeTimeNotConfirmDetails;
...
public class AttendeTimeNotConfirmedAdapter extends RecyclerView.Adapter<AttendeTimeNotConfirmedAdapter.MyViewHolder> {
    ...
    public AttendeTimeNotConfirmedAdapter(Activity activity, ArrayList<AAvaliableModel> arryList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(activity, AttendeTimeNotConfirmDetails.class);
