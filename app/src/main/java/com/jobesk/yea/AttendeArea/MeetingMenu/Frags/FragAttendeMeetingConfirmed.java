...
import com.jobesk.yea.AttendeArea.MeetingMenu.Adapters.SponsorMeetingsConfirmAdapter;
...
public class FragAttendeMeetingConfirmed extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SponsorMeetingsConfirmAdapter mAdapter;
    private Activity activity;
    private ArrayList<AAvaliableModel> arrayList = new ArrayList<>();
    private RecyclerView recyclerView;
    private AAvaliableModel model;
    private String TAG = "FragAttendeMeetingConfirmed";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.frag_sponsor_meeting_confirmed, container, false);
        ...
        mAdapter = new SponsorMeetingsConfirmAdapter(activity, arrayList);
...
//            mParams.put("postId", email);
            ...
            WebReq.get(getActivity(), "attendee-meeting-confirmed?attendee_id=" + userID, mParams, new MyTextHttpResponseHandler());
